...
namespace AppStoneLibrary.Tables
{
    public class Employee
    {
        ...
        public static string employeeHtmlUpdatable(Employee employee)
        {
            ...
            sb.Append("        <input name = \"txtAd\" type=\"text\" class=\"form-control\" id=\"street\" value=\"" + employee.Street + "\">");
            sb.Append("    </div>");
            sb.Append("    <div class=\"col-md-8 col-lg-9\">");
            sb.Append("        <input name = \"txtAd\" type=\"text\" class=\"form-control\" id=\"HouseNo\" value=\"" + employee.HouseNumber + "\">");
            sb.Append("    </div>");
            sb.Append("    <div class=\"col-md-8 col-lg-9\">");
            sb.Append("        <input name = \"txtAd\" type=\"text\" class=\"form-control\" id=\"City\" value=\"" + employee.City + "\">");
            sb.Append("    </div>");
            sb.Append("    <div class=\"col-md-8 col-lg-9\">");
            sb.Append("        <input name = \"txtAd\" type=\"text\" class=\"form-control\" id=\"Department\" value=\"" + employee.Department + "\">");
            sb.Append("    </div>");
            sb.Append("    <div class=\"col-md-8 col-lg-9\">");
